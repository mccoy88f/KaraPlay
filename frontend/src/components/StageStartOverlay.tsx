...
/** Area player centrata all'80%: i bordi restano liberi per controlli nativi o margini palco. */
export const STAGE_PLAYER_FRAME_CLASS =
  "absolute left-1/2 top-1/2 h-[80%] w-[80%] max-h-full max-w-full -translate-x-1/2 -translate-y-1/2";
...
export function StageStartOverlay({
  ...
  return (
    <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
      <div
        className={`${STAGE_PLAYER_FRAME_CLASS} pointer-events-auto flex flex-col items-center justify-center gap-4 rounded-2xl bg-black/60 px-6 text-center`}
      >
